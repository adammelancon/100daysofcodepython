...
def add_resources():
    ...
    print(f" Money: ${round_money(resources['money'])}")
    print("--------------------------------------------------")
    add_what = input("What are you adding? [W]ater / [M]ilk / [C]offee / [E]xit: ").lower()
    if add_what == "w":
        resources['water'] = resources['water'] + int(input("Enter water amount in ml: "))
        add_resources()
    elif add_what == "m":
        resources['milk'] = resources['milk'] + int(input("Enter milk amount in ml: "))
        add_resources()
    elif add_what == "c":
        resources['coffee'] = resources['coffee'] + int(input("Enter coffee amount in ml: "))
        add_resources()
    elif add_what == "e":
        take_order()
...
def take_money():
    ...
    resources['money'] = float(resources['money']) + float(round_money(total_pay))
...
def take_order():
    ...
    order = input("​What would you like? [E]spresso / [L]atte / [C]appuccino: ").lower()
...
def make_drink(drink_type):
    ...
    if drink_type == 'l':
        ...
        resources['latte'] = resources['coffee'] - MENU['latte']["ingredients"]['coffee']
    ...
    if drink_type == 'c':
        ...
        resources['latte'] = resources['coffee'] - MENU['cappuccino']["ingredients"]['coffee']
